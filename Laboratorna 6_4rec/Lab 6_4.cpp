...
int main()
{
	...
	cout << "}" << endl;
	double dobutok = 1;
	cout << "Добуток додатних елементів масиву = " << Dobutok(a, n, i, dobutok) << endl;
	double suma = 0;
	double min = a[0];
	cout << "Мінімальний елемент у масиві = " << find_min(a, n, i, min) << endl;
	cout << "Сума елентів масиву до мінімального елемента = " << Suma(a, n, i, suma, min) << endl;
	cout << "Сортування за зростанням елементів, які стоять на парних місцях: " << endl;
	cout << "a[] = { ";
	sort_parni(a, n, i + 1);
	print(a, n, i);
	cout << "}" << endl;
	cout << "Сортування за зростанням елементів, які стоять на непарних місцях: " << endl;
	sort_neparni(a, n, i);
	cout << "a[] = { ";
	print(a, n, i);
	cout << "}" << endl;
